...
\begin{problem}
  \label{prob:seq-converges-iff-abs-diff-converges}
...
\begin{problem}
  \label{prob:abs-value-of-convergent-sequence}
  ...
  \begin{proof}
    ...
    \]
    Therefore, $\lim\limits_{n \to \infty} \abs{a_{n}} = \abs{L}$, and so $(\abs{a_{n}})$ converges\footnotemark{} to $\abs{L}$.
  \end{proof}
  \footnotetext{
...
\begin{problem}
  ...
  \begin{proof}
    ...
    \begin{subproof}[Proof of \lemref{lem:convergence-of-subsequences-iff-convergence-of-sequence}]
