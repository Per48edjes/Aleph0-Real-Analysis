...
\begin{callout}
  ...
  An immediate consequence of \thmref{thm:extreme-value-theorem} is the following:
...
\begin{problem}
  ...
  \begin{proof}
    ...
    by the result of \probref{prob:composition-continuous}.
    Then by \thmref{thm:extreme-value-theorem}, $g \circ f$ attains a minimum $m$ on $[a,b]$.
